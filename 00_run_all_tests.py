...
tests_aborted_file_path = test_suit_path + "/00_tests_aborted.report"
print("### generating aborted test report in file " + tests_aborted_file_path)
os.system("echo '### test aborted report ###' >" + tests_aborted_file_path)
os.system("echo '### Seg faults : ###' >>" + tests_aborted_file_path)
os.system("grep SIGTERM -R " + test_suit_path + " >> " + tests_aborted_file_path)
os.system("echo '### Sig kill : ###' >> " + tests_aborted_file_path)
os.system("grep SIGSEG -R " + test_suit_path + " >> " + tests_aborted_file_path)
